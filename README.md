# Shingo Shintani Personal Portfolio

静的なワンページ構成の公式プロフィール / ポートフォリオサイトです。

## Preview

`index.html` をブラウザで開くか、任意のローカルWebサーバーでこのフォルダを配信してください。
...
- `index.html`: ページ構造とコピー
- `styles.css`: レイアウト、配色、アニメーション、レスポンシブ対応
- `script.js`: JP / EN 切替、モバイルメニュー、スクロール表示
